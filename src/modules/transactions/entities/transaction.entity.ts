...
export const Transaction = defineEntity({
  ...
  properties: {
    ...
    totalTreatmentAmount: p.decimal().columnType('decimal(10,2)'),
    totalProductAmount: p.decimal().columnType('decimal(10,2)'),
    treatmentCommissionRate: p.decimal().columnType('decimal(5,2)'),
    productCommissionRate: p.decimal().columnType('decimal(5,2)'),
    treatmentCommissionAmount: p.decimal().columnType('decimal(10,2)'),
