...
export class Migration20260619022102 extends Migration {
  ...
  override up(): void | Promise<void> {
    this.addSql(`create table "transactions" ("id" uuid not null, "customer_id" uuid null, "cashier_id" uuid not null, "barber_id" uuid not null, "subtotal" decimal(10,2) not null, "discount_amount" decimal(10,2) not null default '0', "total" decimal(10,2) not null, "total_treatment_amount" decimal(10,2) not null, "total_product_amount" decimal(10,2) not null, "treatment_commission_rate" decimal(5,2) not null, "product_commission_rate" decimal(5,2) not null, "treatment_commission_amount" decimal(10,2) not null, "product_commission_amount" decimal(10,2) not null, "total_commission_amount" decimal(10,2) not null, "points_earned" int not null default 0, "points_used" int not null default 0, "payment_method" varchar(255) not null, "xendit_invoice_id" varchar(255) null, "payment_url" varchar(255) null, "paid_at" timestamptz null, "status" varchar(255) not null, "created_at" timestamptz not null, primary key ("id"));`);
